...
module.exports = async function (t) {
  ...
  const check = (id, d, q) => {
    ...
    if (q.pic) {
      const KINDS = { pie: ["n", "k"], clock: ["h"], blocks: ["tens", "ones"], rect: ["l", "w"], angle: ["deg"], suppl: ["a"], bars: ["items"], coins: ["values"], compare: ["a", "b"], numline: ["lo", "hi", "mark"], turn: ["q"], measure: ["n"], picto: ["rows"] };
